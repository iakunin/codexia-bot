...
public class ForksUpResultRepositoryIntegrationTest extends AbstractIntegrationTest {
    ...
    public void findFirstByGithubRepoHappyPath() {
        ...
        final var result = this.createForksUpResult(repo, stat);
    ...
    public void findFirstByGithubRepoWithinMultipleResults() {
        final var repo = this.createGithubRepo();
        final var stat = this.createGithubRepoStat(repo);
        final var first = this.createForksUpResult(repo, stat);
        final var second = this.createForksUpResult(repo, stat);
        this.manager.persist(repo);
        this.manager.persist(stat);
    ...
    private ForksUpResult createForksUpResult(final GithubRepo repo, final GithubRepoStat stat) {
